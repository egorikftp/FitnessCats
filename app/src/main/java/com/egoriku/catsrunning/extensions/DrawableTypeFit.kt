...
fun typeFitIcon(@TypeFit typeFit: Int) = when (typeFit) {
    TypeFit.WALKING -> R.drawable.ic_vec_directions_walk_40dp
    TypeFit.RUNNING -> R.drawable.ic_vec_directions_run_40dp
    TypeFit.CYCLING -> R.drawable.ic_vec_directions_cycling_40dp
    else -> R.drawable.ic_vec_black_cat
}
